...
import (
	...
	"github.com/techxmind/go-gecko/format"
	"github.com/techxmind/go-gecko/v3/types"
)

var baseURL = "https://api.coingecko.com/api/v3"
var baseURLPro = "https://pro-api.coingecko.com/api/v3"
...
func (c *Client) SimpleTokenPrice(id string, contractAddresses []string, vsCurrencies []string) (*map[string]map[string]float32, error) {
	...
	url := fmt.Sprintf("%s/simple/token_price/%s?%s", c.baseURL, id, params.Encode())
	resp, err := c.MakeReq(url)
	if err != nil {
		return nil, err
	}
